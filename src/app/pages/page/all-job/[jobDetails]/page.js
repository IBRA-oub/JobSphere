          ...
          <div className='w-[90%]  flex space-x-7  h-16'>
            ...
            <div className='w-[72%]  flex flex-col space-y-5 '>
              ...
              <div className='w-full '>
                ...
                <div className='pl-3 mt-3 font-light'>
                  ...
                  <p>
                    - Nunc sed a nisl purus. Nibh dis faucibus proin lacus tristique. Sit congue non vitae
                  </p>
            ...
            <div className='w-full md:w-[26%] flex flex-col h-[100vh] bg-[#30968850] rounded-lg p-4 space-y-7'>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>Job Title</p>
                  <p className='text-[12px] font-light text-gray-700'>Développeur Full Stack Javascript</p>
                </div>
              </div>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>Job Type</p>
                  <p className='text-[12px] font-light text-gray-700'>Full Time</p>
                </div>
              </div>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>Category</p>
                  <p className='text-[12px] font-light text-gray-700'>Informatique</p>
                </div>
              </div>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>Experience</p>
                  <p className='text-[12px] font-light text-gray-700'>2 years</p>
                </div>
              </div>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>Degree</p>
                  <p className='text-[12px] font-light text-gray-700'>Bac +3</p>
                </div>
              </div>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>offered Salary</p>
                  <p className='text-[12px] font-light text-gray-700'>$40000-$60000</p>
                </div>
              </div>
              ...
              <div className='flex pl-6 items-center space-x-4 mt-5'>
                ...
                <div>
                  <p>Location</p>
                  <p className='text-[12px] font-light text-gray-700'>New York , USA</p>
                </div>
              </div>
            </div>
          </div>
