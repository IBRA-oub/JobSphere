        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-100">
                <div className="text-center">
                    ...
                    <h1 className="text-3xl font-bold text-gray-700 mb-2">Job Not Found</h1>
                    <p className="text-gray-500 mb-4">We couldn't find the job you were looking for.</p>


                    <Link href='/pages/page/all-job' className="px-6 py-2 text-white bg-[#309688] rounded-full hover:bg-[#3bb7a7] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300 ease-in-out">
                        Go Back
                    </Link>
                </div>
            </div>
